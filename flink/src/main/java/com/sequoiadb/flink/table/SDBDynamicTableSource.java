...
public class SDBDynamicTableSource implements ScanTableSource,
    ...
    public DynamicTableSource copy() {
        LOG.debug("copy SDBDynamicTableSource, source options: {}, matcher:{}, limit:{}",
                sourceOptions, matcher, limit);
        SDBDynamicTableSource source = new SDBDynamicTableSource(sourceOptions, producedDatatype);
